...
<head>  
    ...
    <title>Sold Comparables Analysis</title>  
...
<body class="bg-gray-50 text-gray-800 font-sans p-4 md:p-8">  
    ...
    <div class="max-w-7xl mx-auto">  
        ...
        <header class="mb-8 text-center md:text-left md:flex md:justify-between md:items-end">  
            <div>  
                <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">Sold Comparables Analysis</h1>  
        ...
        <!-- F. Sold Comparables Analysis Summary -->  
        <section class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-10">  
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">  
                <div>  
                    <label class="block text-sm font-bold text-gray-900 mb-2">Most Probable Sale Price ($)</label>  
...
<script>  
    ...
    async function generatePDF() {  
        ...
        try {  
            // Title  
            doc.setFontSize(18);  
            doc.text("Sold Comparables Analysis", 14, 15);  
            ...
            if(probablePrice || projectedDom || fullSummary) {  
                ...
                doc.setFont(undefined, 'bold');  
                doc.setFontSize(14);  
                doc.text("Sold Comparables Analysis Summary", 14, y);  
                doc.setFontSize(10);  
                y += 8;  
  
                if (probablePrice || projectedDom) {  
                    doc.setFont(undefined, 'bold');  
                    let priceStr = probablePrice ? `Most Probable Sale Price: $${Number(probablePrice).toLocaleString()}` : '';  
