...
export const submarketAnalysisAsIsForm: LocalFormDefinition = {
  ...
  fields: [
    ...
    { id: "sm_total_listing_activity", label: "Total Listing Activity", kind: "number" },
    {
    ...
    { id: "submarketSalesActivityDivider", label: "Submarket Sales Activity", kind: "divider", placeholder: "Sales and listing statistics for the specific submarket (competitive set)." },
    { id: "sm_sold_total", label: "Total Sold Listings", kind: "number" },
    { id: "sm_sold_low_price", label: "Low Price", kind: "text" },
    { id: "sm_sold_high_price", label: "High Price", kind: "text" },
    { id: "sm_sold_median_price", label: "Median Price", kind: "text" },
    { id: "sm_sold_avg_dom", label: "Average DOM", kind: "text" },
    { id: "sm_sold_list_to_price", label: "List-to-Price Ratio", kind: "text" },
    { id: "sm_sold_summary", label: "Summary of Sold Listing Activity", kind: "textarea" },
    { id: "sm_active_total", label: "Total Active Listings", kind: "number" },
    { id: "sm_active_low_price", label: "Low Price", kind: "text" },
    { id: "sm_active_high_price", label: "High Price", kind: "text" },
    { id: "sm_active_median_price", label: "Median Price", kind: "text" },
    { id: "sm_active_avg_dom", label: "Average DOM", kind: "text" },
    ...
    { id: "submarketDistressedActivityDivider", label: "Submarket Distressed Activity", kind: "divider", placeholder: "Presence and impact of distressed inventory within the specific submarket." },
    { id: "sm_distressed_total", label: "Total Distressed Listings", kind: "number" },
    { id: "sm_distressed_pct", label: "Percent of Listings that Were Distressed", kind: "text" },
    ...
    { id: "sm_rent_total_listing_activity", label: "Total Rental Listing Activity", kind: "number", visibleWhen: { fieldId: "sm_rental_analysis_exclude", values: ["No"] } },
    {
    ...
    { id: "sm_rent_vacancy_rate", label: "Vacancy Rate", kind: "text", visibleWhen: { fieldId: "sm_rental_analysis_exclude", values: ["No"] } },
    { id: "sm_rented_total", label: "Total Rented Listings", kind: "number", visibleWhen: { fieldId: "sm_rental_analysis_exclude", values: ["No"] } },
    { id: "sm_rented_low_price", label: "Low Price", kind: "text", visibleWhen: { fieldId: "sm_rental_analysis_exclude", values: ["No"] } },
    { id: "sm_rented_high_price", label: "High Price", kind: "text", visibleWhen: { fieldId: "sm_rental_analysis_exclude", values: ["No"] } },
    { id: "sm_rented_median_price", label: "Median Price", kind: "text", visibleWhen: { fieldId: "sm_rental_analysis_exclude", values: ["No"] } },
    { id: "sm_rented_avg_dom", label: "Average DOM", kind: "text", visibleWhen: { fieldId: "sm_rental_analysis_exclude", values: ["No"] } },
    { id: "sm_rented_list_to_price", label: "List-to-Price Ratio", kind: "text", visibleWhen: { fieldId: "sm_rental_analysis_exclude", values: ["No"] } },
    ...
    { id: "sm_rent_active_total", label: "Total Active Rental Listings", kind: "number", visibleWhen: { fieldId: "sm_rental_analysis_exclude", values: ["No"] } },
    { id: "sm_rent_active_low_price", label: "Low Price", kind: "text", visibleWhen: { fieldId: "sm_rental_analysis_exclude", values: ["No"] } },
    { id: "sm_rent_active_high_price", label: "High Price", kind: "text", visibleWhen: { fieldId: "sm_rental_analysis_exclude", values: ["No"] } },
    { id: "sm_rent_active_median_price", label: "Median Price", kind: "text", visibleWhen: { fieldId: "sm_rental_analysis_exclude", values: ["No"] } },
    { id: "sm_rent_active_avg_dom", label: "Average DOM", kind: "text", visibleWhen: { fieldId: "sm_rental_analysis_exclude", values: ["No"] } },
    ...
    { id: "ps_sales_low_low", label: "Low Price Range (Damaged-Poor) - Low Price", kind: "text" },
    { id: "ps_sales_low_high", label: "Low Price Range (Damaged-Poor) - High Price", kind: "text" },
    { id: "ps_sales_low_median", label: "Low Price Range (Damaged-Poor) - Median Price", kind: "text" },
    { id: "ps_sales_avg_low", label: "Average Price Range (Fair-Average) - Low Price", kind: "text" },
    { id: "ps_sales_avg_high", label: "Average Price Range (Fair-Average) - High Price", kind: "text" },
    { id: "ps_sales_avg_median", label: "Average Price Range (Fair-Average) - Median Price", kind: "text" },
    { id: "ps_sales_high_low", label: "High Price Range (Good-Excellent) - Low Price", kind: "text" },
    { id: "ps_sales_high_high", label: "High Price Range (Good-Excellent) - High Price", kind: "text" },
    { id: "ps_sales_high_median", label: "High Price Range (Good-Excellent) - Median Price", kind: "text" },
    {
    ...
    { id: "ps_rent_avg_low", label: "Average Rental Range (Fair-Average) - Low Price", kind: "text", visibleWhen: { fieldId: "ps_rent_analysis_exclude", values: ["No"] } },
    { id: "ps_rent_avg_high", label: "Average Rental Range (Fair-Average) - High Price", kind: "text", visibleWhen: { fieldId: "ps_rent_analysis_exclude", values: ["No"] } },
    { id: "ps_rent_avg_median", label: "Average Rental Range (Fair-Average) - Median Price", kind: "text", visibleWhen: { fieldId: "ps_rent_analysis_exclude", values: ["No"] } },
    { id: "ps_rent_high_low", label: "High Rental Range (Good-Excellent) - Low Price", kind: "text", visibleWhen: { fieldId: "ps_rent_analysis_exclude", values: ["No"] } },
    { id: "ps_rent_high_high", label: "High Rental Range (Good-Excellent) - High Price", kind: "text", visibleWhen: { fieldId: "ps_rent_analysis_exclude", values: ["No"] } },
    { id: "ps_rent_high_median", label: "High Rental Range (Good-Excellent) - Median Price", kind: "text", visibleWhen: { fieldId: "ps_rent_analysis_exclude", values: ["No"] } },
    {
