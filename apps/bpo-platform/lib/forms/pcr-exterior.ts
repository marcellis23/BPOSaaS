...
export const pcrExteriorForm: LocalFormDefinition = {
  ...
  fields: [
    ...
    { id: "utilityHeatingCooling", label: "Heating & Cooling", kind: "checkboxes", options: ["Natural Gas (utility line)", "Propane (private tank)", "Fuel Oil (storage tank)", "Electric Heat Pump / HVAC", "Unknown / Not Assessed"] },
    ...
    { id: "overallExteriorSummary", label: "Overall Exterior Details Summary", kind: "textarea", placeholder: "Max 1500 characters. Use this for the final summary/explanation." },
