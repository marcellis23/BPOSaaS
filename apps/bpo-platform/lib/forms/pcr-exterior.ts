...
export const pcrExteriorForm: LocalFormDefinition = {
  ...
  description: "Exterior-only property condition report for drive-by, curbside, or restricted-access inspections.",
  fields: [
    ...
    { id: "useConsistentExplain", label: "Explain Inconsistency", kind: "textarea", placeholder: "Required if No is selected. Suggested: 50-150 characters." },
    ...
    { id: "utilityHeatingCooling", label: "Heating & Cooling", kind: "checkboxes", options: ["Natural Gas", "Propane", "Fuel Oil", "Electric Heat Pump / HVAC", "Unknown / Not Assessed"] },
    ...
    { id: "utilityWastewater", label: "Wastewater Disposal", kind: "checkboxes", options: ["Public Sewer", "Private Septic System", "Holding Tank", "Unknown / Not Assessed"] },
    ...
    { id: "exteriorStructureRating", label: "Condition Rating (Exterior Structure and Components)", kind: "select", required: true, options: conditionOptions },
    ...
    { id: "roofSystemRating", label: "Condition Rating (Roof System)", kind: "select", required: true, options: conditionOptions },
    ...
    { id: "entryOpeningsRating", label: "Condition Rating (Entry and Exterior Openings)", kind: "select", required: true, options: conditionOptions },
    ...
    { id: "overallExteriorSummary", label: "Overall Exterior Summary Details", kind: "textarea", placeholder: "Major deferred maintenance, recent improvements, or exterior issues not covered above." },

    { id: "commonAreaInspectionDivider", label: "Common Area Inspection", kind: "divider", placeholder: "Assess shared areas and amenities when available for exterior/common access inspection.", visibleWhen: associationVisible },
